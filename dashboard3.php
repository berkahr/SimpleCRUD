...
<body>
  <header class="header">
    <a href="#" class="logo"><span>Warteg</span>Berhias</a>
  ...
  <section name="menu">
    <div class="content">
        <div class="container"> 
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="img\food1.png" alt="Teh Tarik" class="img-fluid" id="imgmenu">
              <h4 class="title">Teh Tarik</h4>
              <p class="title">Teh tarik dengan rasa manis dan aroma yang khas, cocok untuk menemani makan siang.</p>
            </div>
            <div class="col-md-4">
              <img src="img\food1.png" alt="Kopi Hitam" class="img-fluid">
              <h4 class="title">Kopi Hitam</h4>
              <p>Kopi hitam pekat dan pahit, cocok untuk kamu yang suka kopi strong.</p>
            </div>
            <div class="col-md-4">
              <img src="img\food1.png" alt="Susu Jahe" class="img-fluid">
              <h4 class="title">Susu Jahe</h4>
              <p class="title">Susu jahe hangat yang menyegarkan, cocok untuk menghangatkan badan.</p>
            </div>
          </div>
        </div>
    </div>
  </section>
  <section name="waktu" class="waktulokasi">
    <div class="container">
